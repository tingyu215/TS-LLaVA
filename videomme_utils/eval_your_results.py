...
def eval_your_results(
    ...
    if return_task_types_accuracy:
        ...
        print("Task Categories")
        print("-------------------------------------")
        dict_task = {"Temporal": {"correct":0, "answered":0}, "Spatial":{"correct":0, "answered":0}, "Action": {"correct":0, "answered":0}, "Object": {"correct":0, "answered":0}, "Attribute": {"correct":0, "answered":0}, "OCR": {"correct":0, "answered":0}, "Counting": {"correct":0, "answered":0}, "Information": {"correct":0, "answered":0},}
        for q_type in TASK_CATEGORIES:
            ...
            if q_type.split(" ")[0] in dict_task.keys():
                dict_task[q_type.split(" ")[0]]["correct"] += total_correct
                dict_task[q_type.split(" ")[0]]["answered"] += total_answered
        print("-------------------------------------")
        for key in dict_task.keys():
            task_acc = dict_task[key]["correct"]/dict_task[key]["answered"]
            print(f"{key}:{task_acc}")
