...
video_dir="BASE_VIDEO_DIR/nextqa/NExTVideo"
gt_file_qa="./TS-LLaVA/playground/gt_qa_files/NExTQA/val_qa.json"
output_dir="./TS-LLaVA/output/NExTQA_Zero_Shot_QA_TS/${CKPT_NAME}_u${num_frames}FRS_${aggregation_method}_${num_sampled_tokens}tokens_${prompt_version}_${image_aspect_ratio}"
