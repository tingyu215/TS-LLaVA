...
video_dir="BASE_VIDEO_DIR/MSVD_Zero_Shot_QA/videos"
GT_QA_DIR="./TS-LLaVA/playground/gt_qa_files"
output_dir="./TS-LLaVA/output/MSVD_Zero_Shot_QA_TS/${CKPT_NAME}_u${num_frames}FRS_${aggregation_method}_${num_sampled_tokens}tokens_${prompt_version}_${image_aspect_ratio}"
